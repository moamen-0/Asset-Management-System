...
namespace AssetManagementSystem.DAL.Data.Migrations
{
    ...
    [Migration("20250304063503_AddSupervisorRelationship")]
    partial class AddSupervisorRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.DisbursementItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DisbursementItems");
                });

            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.DisbursementRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DisbursementRequests");
                });
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.ReturnDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReturnCommittee")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ReturningDepartment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.ReturnDocumentItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.StoreKeeper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AssetTypeTag")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.Asset", b =>
                {
                    ...
                    b.HasOne("AssetManagementSystem.DAL.Entities.User", "Supervisor")
                        .WithMany("SupervisedAssets")
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.DisbursementItem", b =>
                {
                    b.HasOne("AssetManagementSystem.DAL.Entities.DisbursementRequest", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("AssetManagementSystem.DAL.Entities.ReturnDocumentItem", b =>
                {
                    b.HasOne("AssetManagementSystem.DAL.Entities.ReturnDocument", "ReturnDocument")
                        .WithMany("Items")
